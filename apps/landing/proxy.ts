...
export const config = {
  ...
  matcher: [
    "/((?!_next|favicon|icon|apple-icon|api|shop|orders|collectibles|play|vault|explore|ideas|quests|timeline|projects|report|hackatime|refers|account|docs|img|fonts|pixl|index|hero-bg|step-|pixel_|hc-logo).*)",
  ],
};
