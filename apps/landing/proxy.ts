...
export const config = {
  ...
  matcher: [
    "/((?!_next|favicon|api|shop|orders|collectibles|play|vault|explore|quests|timeline|projects|report|hackatime|docs|img|fonts|pixl|index|hero-bg|step-|pixel_|hc-logo).*)",
  ],
};
